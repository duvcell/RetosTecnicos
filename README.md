...
Crea Usuarios, Snippets en la página de Gruyene
...
---
Se utiliza el IDE de IntelliJ IDEA para el desarrollo de la automatización. IntelliJ IDEA es un entorno de desarrollo integrado para el desarrollo de programas informáticos. Es desarrollado por JetBrains, y está disponible en dos ediciones: edición para la comunidad​ y edición comercial.
